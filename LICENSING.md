...
someip-rs is available under a **dual-licensing** model:
...
This means you can use someip-rs in:
...
For commercial licensing inquiries, pricing, and terms, please [create an **Issue** in GitHub](https://github.com/reneherrero/someip-rs/issues).
...
By contributing to someip-rs, you agree that your contributions will be
